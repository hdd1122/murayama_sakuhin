...
void ParticleSystem::Init(UINT maxParticles, const char* fileName)
{
	...
	for (UINT i = 0; i < m_MaxParticles; ++i)
	{
		...
		//initialParticles[i].Life = 10000.0f; // 寿命を少しばらつかせる
